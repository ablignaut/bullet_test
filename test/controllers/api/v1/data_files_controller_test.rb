...
def setup
  ...
  @data_file.document = Rack::Test::UploadedFile.new("test/support/foo.txt")
  @another_data_file.document = Rack::Test::UploadedFile.new("test/support/foo.txt")
...
def assert_proper_object_serialization(data_file_data)
  ...
  assert_equal data_file_data['document'], rails_blob_path(@data_file.document) unless controller.action_name == 'create'
